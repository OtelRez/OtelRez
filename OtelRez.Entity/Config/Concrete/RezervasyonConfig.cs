...
namespace OtelRez.Entity.Config.Concrete
{
    public class RezervasyonConfig : BaseConfig<Rezervasyon>
    {
        public override void Configure(EntityTypeBuilder<Rezervasyon> builder)
        {
            ...
            builder.HasData(new Rezervasyon() { Id = 2, Giris = DateOnly.Parse("2024-12-20"), Cikis = DateOnly.Parse("2024-12-22"), CreateTime = DateOnly.FromDateTime(DateTime.Now), KullaniciId = 1, OdaId = 4 });
            builder.HasData(new Rezervasyon() { Id = 3, Giris = DateOnly.Parse("2024-11-18"), Cikis = DateOnly.Parse("2024-12-05"), CreateTime = DateOnly.FromDateTime(DateTime.Now), KullaniciId = 2, OdaId = 10 });
